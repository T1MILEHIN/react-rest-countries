...
export default function Currency() {
    ...
    const {data: searchedCountry, error, isLoading} = SearchCountry(currency, url)
    if (error?.response?.data?.status === 404) error.message = `${currency} is not a valid Currency`;
    ...
    return (
        <div className="overflow-x-hidden">
            ...
            <div className="min-h-screen p-2 md:p-10 grid grid-cols-1 lg:grid-cols-3 gap-5">
